...
INSTR_FIELDS = {
    'general': [
        ...
        {
            'key': 'detdist', 'label': 'detector distance', 'unit': 'mm', 'type': 'float',
            'description': 'Sample-to-detector distance.'
        },
        {
            'key': 'scan_step', 'label': 'scan_step', 'unit': 'deg', 'type': 'float',
